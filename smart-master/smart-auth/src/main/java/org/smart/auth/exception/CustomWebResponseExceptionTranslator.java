package org.smart.auth.exception;
...
public class CustomWebResponseExceptionTranslator extends DefaultWebResponseExceptionTranslator{
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        if (e instanceof HystrixRuntimeException) {
            ...
            oAuth2Exception.addAdditionalInformation("ec", code);
            oAuth2Exception.addAdditionalInformation("em", message);
        } else {
            ...
            oAuth2Exception.addAdditionalInformation("ec", StringUtils.isNotEmpty(errorCode) ? errorCode : GenericErrorCodes.GENERIC_API_ERROR_CODE.getCode() + "");
            oAuth2Exception.addAdditionalInformation("em", "账号认证失败");
